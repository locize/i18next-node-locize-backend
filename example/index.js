...
i18next.init({
  ...
  backend: {
    ...
    projectId: '2596e805-2ce2-4e21-9481-ee62202ababd',
		//version: 'staging',
    loadPath: 'https://api-dev.locize.io/2596e805-2ce2-4e21-9481-ee62202ababd/{{version}}/{{lng}}/{{ns}}',
    addPath: 'https://api-dev.locize.io/missing/2596e805-2ce2-4e21-9481-ee62202ababd/{{version}}/{{lng}}/{{ns}}'
  }
});
